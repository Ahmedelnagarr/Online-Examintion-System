...
<table align="center"  cellspacing="10" cellpadding="10">
	...
	<tr>
		<td><input type="text"  name="Subject" align="center" disabled></td>
		<td><input type="text"  name="History" align="center" disabled></td>
		<td><input type="text"  name="From" align="center" disabled></td>
		<td><input type="text"  name="To" align="center" disabled></td>
	</tr>
