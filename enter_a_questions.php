...
<article>
	...
	<div class="art">
		...
		<h1>Enter A Questions</h1><br>

	<form>
		<input type="text" name="Questions"  placeholder="Questions"><br>
		<input type="radio" name="gender" value="answer 1" >
		<input type="text" name="answer 1"  placeholder="answer 1"><br>

		<input type="radio" name="gender" value="answer 2">
		<input type="text" name="answer 2"  placeholder="answer 2"><br>

		<input type="radio" name="gender" value="answer 3">
		<input type="text" name="answer 3"  placeholder="answer 3"><br>

		<input type="radio" name="gender" value="answer 4">
		<input type="text" name="answer 4"  placeholder="answer 4"><br>
		<p>______________________________________________________________________________</p>
	</form>

	<input class="button"  type="submit" id="btn" name="submit" value="Add Questions" ><br>
